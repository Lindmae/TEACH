...
void DX::DeviceResources::CreateDeviceResources()
{
    ...
    // Create the Direct3D 11 device object and a corresponding context.
...
{
    // By default, the PresentUsingCurrentPrediction method waits for the frame to finish
    // before it returns. Holographic apps should wait for the previous frame to finish
    // before starting work on a new frame. This allows for better results from
    ...
    // The PresentUsingCurrentPrediction method detects when the graphics device
